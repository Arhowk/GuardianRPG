...
--[[
  ...
  -Ensure that you have the guardianrpg_notifications.xml, guardianrpg_notifications.js, and guardianrpg_notifications.css files in your panorama content folder.
  -Ensure that guardianrpg_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/guardianrpg_notifications.xml" />
