...
--[[
  ...
  -Ensure that you have the guardianrpg_attachments.xml, guardianrpg_attachments.js, and guardianrpg_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that guardianrpg_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/guardianrpg_attachments.xml" />
