...
--[[
  ...
  See GuardianRPG:PostLoadPrecache() in guardianrpg.lua for more information
  ]]

  DebugPrint("[GUARDIANRPG] Performing pre-load precache")
...
function Activate()
  GameRules.GuardianRPG = GuardianRPG()
  GameRules.GuardianRPG:_InitGuardianRPG()
end
